      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-bold text-xl">Bravo AI Systems</span>
          </div>
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Join thousands of professionals who are already using Bravo AI Systems to grow their business.
          </p>
          <Link to="/auth">
            <Button variant="secondary" size="lg" className="text-lg px-8">
      ...
      <footer className="py-12 border-t">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-heading font-bold">Bravo AI Systems</span>
          </div>
          <p>&copy; 2025 Bravo AI Systems. All rights reserved.</p>
