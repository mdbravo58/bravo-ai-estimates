  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hi! I\'m your Bravo AI Systems assistant. I\'m here to help you learn how to use the software. Ask me anything about features, navigation, or how to complete tasks!',
      timestamp: new Date()
    }
  ]);
